...
// ----------------------- Exported prototypes -----------------------
extern bool writeI2C(I2C_Handle handle,uint8_t ui8Addr, uint8_t ui8Reg, uint8_t *Data);
extern bool readI2C(I2C_Handle handle,uint8_t ui8Addr,uint16_t regAddr,uint8_t *data);
